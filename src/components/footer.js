...
import { Discord, EnvelopeFill, Telegram, Twitter } from 'react-bootstrap-icons';
    ...
    <footer className='mt-1'>
      ...
      <Row>
        ...
        <Col md='5' className='p-2 d-flex justify-content-center align-items-center gap-3'>
          ...
          <a href='https://t.me/rip_xg' target='_blank'><FontAwesomeIcon className='mx-1' size="2xl" icon={faPaperPlane} style={{color: "#ffffff",}} /></a>
          <a href='https://discord.gg/DGYxUBWqex' target='_blank'><Discord className='mx-1' size={40}></Discord></a>
          <a href='https://twitter.com/XGlobalGG?s=20' target='_blank'><Twitter className='mx-1' size={40}></Twitter></a>
